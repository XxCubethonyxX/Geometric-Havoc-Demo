  ...
  public static function lerpDelta(base:Float, target:Float, speed:Float, deltaTime:Float):Float
{
  ...
  //pulled from fnfs flixel fork for here

  /**
     * Converts linear volume (0–1) into logarithmic scale.
     * @param x Linear input value.
     * @param minValue The minimum logarithmic value (default: 0.001).
    ...
    /**
     * Converts logarithmic volume back into linear scale (0–1).
     * @param x Logarithmic input value.
     * @param minValue The minimum logarithmic value (default: 0.001).
     * @return Linear value.
     */
